...
export const javaTopics: TutorialTopic[] = [
  {
    ...
    theory: [
      ...
      'Java is the most popular language for enterprise systems in India and globally. Companies using Java: TCS, Infosys, HCL, Wipro, IBM, Google, Amazon, Twitter, LinkedIn, eBay, and countless Indian startups. ISRO uses Java for satellite systems. Indian IT companies train millions in Java annually. Java developers have the highest average salaries in tech jobs, making it invaluable for career growth.',
      'Java is used by 30–35% of developers worldwide and ranks in the top 3 languages globally. According to GitHub and StackOverflow data, Java powers over 90% of enterprise systems in India and globally. The job market has 5+ million Java developer positions globally, with average salary of INR 6–12 LPA in India. Java skills are a gateway to lucrative careers in finance, banking, e-commerce, and tech.',
    ],
