...
export const cssTopics: TutorialTopic[] = [
  {
    ...
    livePreview: true,
    theory: [
      `CSS (Cascading Style Sheets) controls the visual appearance of HTML pages — colors, fonts, sizes, spacing, layout, animations, and responsive design. Without CSS, every website would look like plain text. CSS transforms boring HTML into beautiful, professional interfaces. It is the key to making websites visually stunning and user-friendly.`,
      `Håkon Wium Lie created CSS in 1996 while working at INRIA (French Institute for Research in Computer Science and Automation). He invented it to separate content (HTML) from presentation (CSS), a revolutionary idea at the time. CSS 1 (1996) was simple, CSS 2 (1998) added positioning and media queries, CSS3 (2011+) introduced gradients, transforms, and animations. Modern CSS is still evolving with new features regularly.`,
      `CSS evolved from basic text styling to a powerful design system. Early CSS (1996–2000) was limited; CSS2.1 (2011) was the stable standard that most browsers adopted. CSS3 introduced modules: Flexbox (2015) revolutionized layout, CSS Grid (2017) made complex layouts simple, and Subgrid (2023) enabled nested layouts. Browser support improved dramatically, making CSS feature-rich and practical.`,
      `CSS is used with HTML and JavaScript everywhere. Design frameworks like Tailwind CSS (utility-first, 8+ million weekly downloads), Bootstrap (most popular, used by 15%+ of websites), Foundation, and Material Design simplify CSS. Preprocessors like Sass and Less extend CSS functionality. Animation libraries like Animate.css are CSS-based. Every modern website uses CSS to style its appearance.`,
      `In India and globally, CSS expertise is in high demand. Companies like Flipkart, Swiggy, Amazon, Google, Netflix, and TCS employ CSS specialists. Startups and freelancers use CSS daily for building web interfaces. Indian web designers and frontend developers use CSS to create interfaces for millions of Indian users. For CBSE+ students learning web development, CSS is essential alongside HTML and JavaScript.`,
      `CSS knowledge is critical for frontend careers: 90%+ of frontend jobs require CSS expertise. Global job openings for CSS developers exceed 3 million. Tailwind CSS and modern CSS frameworks are the most demanded skills in 2024–2025. CSS proficiency combined with HTML/JavaScript opens doors to frontend developer roles earning INR 3–12 LPA in India. Mastering CSS separates amateur websites from professional, polished applications.`,
    ],
