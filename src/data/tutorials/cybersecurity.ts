...
export const cybersecurityTopics: TutorialTopic[] = [
  {
    ...
    difficulty: 'Beginner',
    theory: [
      'Cybersecurity is the practice of protecting digital systems, networks, and information from unauthorized access, theft, and damage. It encompasses strategies, tools, and practices designed to keep data safe in the digital world.',
      'The CIA Triad is the foundation of cybersecurity: Confidentiality (keeping data private), Integrity (ensuring data is accurate and unmodified), and Availability (making sure systems are accessible when needed).',
      'Cybersecurity threats come from various sources including hackers, malware, insiders, and natural disasters. Understanding these threats helps organizations build effective defense strategies.',
      'A holistic cybersecurity approach combines technical controls (firewalls, encryption), administrative policies (access rules), and physical security (server room locks) to create layers of protection.'
    ],
