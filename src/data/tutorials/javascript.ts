...
export const javascriptTopics: TutorialTopic[] = [
  {
    ...
    theory: [
      ...
      `In India, JavaScript dominates tech companies: Flipkart, Swiggy, Amazon, Paytm, MakeMyTrip, and TCS all build with JavaScript. Startups like Zerodha and BharatPe use Node.js heavily. Indian developers are among the most active JavaScript contributors on GitHub. JavaScript developer jobs in India have grown 50% annually, with roles in React, Node.js, and full-stack development commanding premium salaries (INR 4–15 LPA).`,
      `JavaScript is used by 70%+ of developers worldwide and is the #1 language on GitHub by contributions. Every major tech company uses JavaScript: Google, Netflix, Facebook, Microsoft, Apple, and more. Job market data shows 2+ million JavaScript developer positions globally. In India specifically, JavaScript proficiency is the most demanded skill after core CS fundamentals, making it essential for any aspiring tech professional.`,
    ],
