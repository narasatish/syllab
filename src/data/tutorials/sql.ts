...
export const sqlTopics: TutorialTopic[] = [
  {
    ...
    theory: [
      ...
      `In India, SQL is critical for every company storing data. Flipkart, Swiggy, Amazon India, HDFC Bank, ICICI Bank, and TCS rely on SQL databases. Government systems like NREGA and census databases use SQL. Indian fintech startups like Paytm and PhonePe use SQL for transaction management. For CBSE Class 12 students, SQL is part of Informatics Practices curriculum in many states.`,
      `SQL knowledge is essential for 99% of tech jobs: backend developers, data analysts, DevOps engineers, and even frontend developers need SQL. Global job openings for SQL-skilled professionals exceed 5+ million. In India, SQL proficiency paired with any programming language opens doors to backend and data roles earning INR 4–15 LPA. SQL is a universal skill that never goes out of style.`,
    ],
