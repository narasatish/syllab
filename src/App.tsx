...
const PomodoroTimer = lazyWithRetry(() => import('./components/PomodoroTimer'), 'components-PomodoroTimer');
...
const HomePage = lazyWithRetry(() => import('./pages/Home'), 'pages-Home');
const SyllabusPage = lazyWithRetry(() => import('./pages/Syllabus'), 'pages-Syllabus');
const ArenaPage = lazyWithRetry(() => import('./pages/Arena'), 'pages-Arena');
const TutorPage = lazyWithRetry(() => import('./pages/Tutor'), 'pages-Tutor');
const LearningLabPage = lazyWithRetry(() => import('./pages/LearningLab'), 'pages-LearningLab');
const DailyChallengesPage = lazyWithRetry(() => import('./pages/DailyChallenges'), 'pages-DailyChallenges');
const ProgressPage = lazyWithRetry(() => import('./pages/ProgressPage'), 'pages-ProgressPage');
const MockTestsPage = lazyWithRetry(() => import('./pages/MockTests'), 'pages-MockTests');
const PrepHubPage = lazyWithRetry(() => import('./pages/PrepHub'), 'pages-PrepHub');
const StudentProfilePage = lazyWithRetry(() => import('./pages/StudentProfile'), 'pages-StudentProfile');
const ParentDashboardPage = lazyWithRetry(() => import('./pages/ParentDashboard'), 'pages-ParentDashboard');
const AboutPage = lazyWithRetry(() => import('./pages/About'), 'pages-About');
const ContactPage = lazyWithRetry(() => import('./pages/Contact'), 'pages-Contact');
const SitemapPage = lazyWithRetry(() => import('./pages/Sitemap'), 'pages-Sitemap');
const AdminPipelinePage = lazyWithRetry(() => import('./pages/AdminPipeline'), 'pages-AdminPipeline');
const BlogPage = lazyWithRetry(() => import('./pages/Blog'), 'pages-Blog');
const UpdatesPage = lazyWithRetry(() => import('./pages/Updates'), 'pages-Updates');
const ClassPage = lazyWithRetry(() => import('./pages/ClassPage'), 'pages-ClassPage');
const SkillsLabPage = lazyWithRetry(() => import('./pages/SkillsLab'), 'pages-SkillsLab');
const EnglishLabPage = lazyWithRetry(() => import('./pages/EnglishLab'), 'pages-EnglishLab');
const CodingChallengesPage = lazyWithRetry(() => import('./pages/CodingChallengesPage'), 'pages-CodingChallengesPage');
const MiniProjectsPage = lazyWithRetry(() => import('./pages/MiniProjectsPage'), 'pages-MiniProjectsPage');
const CodingForKidsPage = lazyWithRetry(() => import('./pages/CodingForKidsPage'), 'pages-CodingForKidsPage');
const PythonForKidsPage = lazyWithRetry(() => import('./pages/PythonForKidsPage'), 'pages-PythonForKidsPage');
const ComputerBasicsPage = lazyWithRetry(() => import('./pages/ComputerBasicsPage'), 'pages-ComputerBasicsPage');
const CyberSafetyPage = lazyWithRetry(() => import('./pages/CyberSafetyPage'), 'pages-CyberSafetyPage');
const AiForStudentsPage = lazyWithRetry(() => import('./pages/AiForStudentsPage'), 'pages-AiForStudentsPage');
const WebDevPage = lazyWithRetry(() => import('./pages/WebDevPage'), 'pages-WebDevPage');
const GeneralKnowledgePage = lazyWithRetry(() => import('./pages/GeneralKnowledge'), 'pages-GeneralKnowledge');
const CareerPredictorPage = lazyWithRetry(() => import('./pages/CareerPredictor'), 'pages-CareerPredictor');
const CollegesPage = lazyWithRetry(() => import('./pages/Colleges'), 'pages-Colleges');
const NcertSolutionsPage = lazyWithRetry(() => import('./pages/NcertSolutions'), 'pages-NcertSolutions');
const LiveQuizPage = lazyWithRetry(() => import('./pages/LiveQuiz'), 'pages-LiveQuiz');
const AlternativesPage = lazyWithRetry(() => import('./pages/Alternatives'), 'pages-Alternatives');
const KidsPage = lazyWithRetry(() => import('./pages/Kids'), 'pages-Kids');
const GkQuestionsPage = lazyWithRetry(() => import('./pages/GkQuestions'), 'pages-GkQuestions');
const ImportantQuestionsPage = lazyWithRetry(() => import('./pages/ImportantQuestions'), 'pages-ImportantQuestions');
const PromptLabPage = lazyWithRetry(() => import('./pages/PromptLab'), 'pages-PromptLab');
const MockExamLandingPage = lazyWithRetry(() => import('./pages/MockExamLanding'), 'pages-MockExamLanding');
const CollegePredictorLandingPage = lazyWithRetry(() => import('./pages/CollegePredictorLanding'), 'pages-CollegePredictorLanding');
const EnglishTopicsPage = lazyWithRetry(() => import('./pages/EnglishTopics'), 'pages-EnglishTopics');
const CareerGuidesPage = lazyWithRetry(() => import('./pages/CareerGuides'), 'pages-CareerGuides');
const PreviousYearPapersPage = lazyWithRetry(() => import('./pages/PreviousYearPapers'), 'pages-PreviousYearPapers');
const FormulaSheetsPage = lazyWithRetry(() => import('./pages/FormulaSheets'), 'pages-FormulaSheets');
const StateBoardSolutionsPage = lazyWithRetry(() => import('./pages/StateBoardSolutions'), 'pages-StateBoardSolutions');
const AiHubPage = lazyWithRetry(() => import('./pages/AiHub'), 'pages-AiHub');
const EmbedPage = lazyWithRetry(() => import('./pages/EmbedPage'), 'pages-EmbedPage');
const MedicalCollegesPage = lazyWithRetry(() => import('./pages/MedicalColleges'), 'pages-MedicalColleges');
const CollegeFinderPage = lazyWithRetry(() => import('./pages/CollegeFinder'), 'pages-CollegeFinder');
const ScholarshipsPage = lazyWithRetry(() => import('./pages/Scholarships'), 'pages-Scholarships');
const DifferencesPage = lazyWithRetry(() => import('./pages/Differences'), 'pages-Differences');
const FullFormsPage = lazyWithRetry(() => import('./pages/FullForms'), 'pages-FullForms');
const GlossaryPage = lazyWithRetry(() => import('./pages/Glossary'), 'pages-Glossary');
const RevisionNotesPage = lazyWithRetry(() => import('./pages/RevisionNotes'), 'pages-RevisionNotes');
const SamplePapersPage = lazyWithRetry(() => import('./pages/SamplePapers'), 'pages-SamplePapers');
const MathsTablesPage = lazyWithRetry(() => import('./pages/MathsTables'), 'pages-MathsTables');
const EnglishWritingPage = lazyWithRetry(() => import('./pages/EnglishWriting'), 'pages-EnglishWriting');
const ChapterMcqsPage = lazyWithRetry(() => import('./pages/ChapterMcqs'), 'pages-ChapterMcqs');
const StaticGkPage = lazyWithRetry(() => import('./pages/StaticGk'), 'pages-StaticGk');
const VisualLearningPage = lazyWithRetry(() => import('./pages/VisualLearning'), 'pages-VisualLearning');
const TimelinesPage = lazyWithRetry(() => import('./pages/Timelines'), 'pages-Timelines');
const WhatToStudyPage = lazyWithRetry(() => import('./pages/WhatToStudy'), 'pages-WhatToStudy');
const QuizDuelPage = lazyWithRetry(() => import('./pages/QuizDuel'), 'pages-QuizDuel');
const PyqsPage = lazyWithRetry(() => import('./pages/Pyqs'), 'pages-Pyqs');
const KidsSubjectLandingPage = lazyWithRetry(() => import('./pages/KidsSubjectLanding'), 'pages-KidsSubjectLanding');
const EnglishVocabPage = lazyWithRetry(() => import('./pages/EnglishVocab'), 'pages-EnglishVocab');
const EnglishLiteraturePage = lazyWithRetry(() => import('./pages/EnglishLiterature'), 'pages-EnglishLiterature');
const ConceptExplainersPage = lazyWithRetry(() => import('./pages/ConceptExplainers'), 'pages-ConceptExplainers');
const SolvedExamplesPage = lazyWithRetry(() => import('./pages/SolvedExamples'), 'pages-SolvedExamples');
const LabPracticalsPage = lazyWithRetry(() => import('./pages/LabPracticals'), 'pages-LabPracticals');
const DoubtSolverPage = lazyWithRetry(() => import('./pages/Scan'), 'pages-Scan');
const MicrolearningPage = lazyWithRetry(() => import('./pages/Microlearning'), 'pages-Microlearning');
const StudyRoomPage = lazyWithRetry(() => import('./pages/StudyRoom'), 'pages-StudyRoom');
const CalculatorsPage = lazyWithRetry(() => import('./pages/Calculators'), 'pages-Calculators');
const StudyPlannerPage = lazyWithRetry(() => import('./pages/StudyPlanner'), 'pages-StudyPlanner');
const CutoffsPage = lazyWithRetry(() => import('./pages/Cutoffs'), 'pages-Cutoffs');
const FlashcardsPage = lazyWithRetry(() => import('./pages/Flashcards'), 'pages-Flashcards');
const AnswerEvaluatorPage = lazyWithRetry(() => import('./pages/AnswerEvaluator'), 'pages-AnswerEvaluator');
const UnitConverterPage = lazyWithRetry(() => import('./pages/UnitConverter'), 'pages-UnitConverter');
const PeriodicTablePage = lazyWithRetry(() => import('./pages/PeriodicTable'), 'pages-PeriodicTable');
const PomodoroPage = lazyWithRetry(() => import('./pages/Pomodoro'), 'pages-Pomodoro');
const MarksTrackerPage = lazyWithRetry(() => import('./pages/MarksTracker'), 'pages-MarksTracker');
const ToolsHubPage = lazyWithRetry(() => import('./pages/ToolsHub'), 'pages-ToolsHub');
const PdfToolkitPage = lazyWithRetry(() => import('./pages/PdfToolkit'), 'pages-PdfToolkit');
const ImageToolkitPage = lazyWithRetry(() => import('./pages/ImageToolkit'), 'pages-ImageToolkit');
const ComparePage = lazyWithRetry(() => import('./pages/ComparePage'), 'pages-ComparePage');
const QuestionPaperGeneratorPage = lazyWithRetry(() => import('./pages/QuestionPaperGenerator'), 'pages-QuestionPaperGenerator');
const NotesPage = lazyWithRetry(() => import('./pages/NotesPage'), 'pages-NotesPage');
const EverydayToolsPage = lazyWithRetry(() => import('./pages/EverydayToolsPage'), 'pages-EverydayToolsPage');
const RomanNumeralsPage = lazyWithRetry(() => import('./pages/RomanNumeralsPage'), 'pages-RomanNumeralsPage');
const ContrastCheckerPage = lazyWithRetry(() => import('./pages/ContrastCheckerPage'), 'pages-ContrastCheckerPage');
const TimestampPage = lazyWithRetry(() => import('./pages/TimestampPage'), 'pages-TimestampPage');
const CsvToJsonPage = lazyWithRetry(() => import('./pages/CsvToJsonPage'), 'pages-CsvToJsonPage');
const ImageToTextPage = lazyWithRetry(() => import('./pages/ImageToTextPage'), 'pages-ImageToTextPage');
const WordCounterPage = lazyWithRetry(() => import('./pages/WordCounterPage'), 'pages-WordCounterPage');
const TextToSpeechPage = lazyWithRetry(() => import('./pages/TextToSpeechPage'), 'pages-TextToSpeechPage');
const WorksheetsPage = lazyWithRetry(() => import('./pages/Worksheets'), 'pages-Worksheets');
const StoryLessonsLandingPage = lazyWithRetry(() => import('./pages/StoryLessonsLanding'), 'pages-StoryLessonsLanding');
