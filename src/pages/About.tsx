  ...
  return (
    <div className="max-w-4xl mx-auto space-y-16 pb-20">
      ...
      <section className="text-center space-y-6">
        ...
        >
Syllab was created to make high-quality education accessible to every student in India â€” from early school learning to advanced exam preparation.        </motion.p>
      </section>
